package com.demo.myapplication.java;
...
public class PaymentActivity extends Activity implements PaymentResultListener {
    ...
    public void startPayment() {
        ...
        try {
            ...
            options.put("name", "Nike Air");
            options.put("description", "Testing Payment");
            options.put("send_sms_hash",true);
            options.put("allow_rotation", true);
            //You can omit the image option to fetch the image from dashboard
            options.put("image", "https://i.ibb.co/8sL1WXz/web-hi-res-512.png");
            options.put("currency", "INR");
            options.put("amount", "100");

            JSONObject preFill = new JSONObject();
            preFill.put("email", "test@nike.com");
            preFill.put("contact", "9552205033");
